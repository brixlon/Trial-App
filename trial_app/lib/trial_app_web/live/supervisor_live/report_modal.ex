defmodule TrialAppWeb.SupervisorLive.ReportModal do
  ...
  def update(assigns, socket) do
    {:ok,
     socket
     |> assign(assigns)
     |> assign(:report_type, "final_report")
  ...
  def render(assigns) do
    ...
    <div class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div class="bg-gray-50 px-6 py-4 flex items-center justify-between gap-3 border-t border-gray-200 shrink-0">
          <p class="text-sm text-gray-600">
            This will generate the final attachment report for download
          </p>
