defmodule TrialAppWeb.OrganizationLive.Index do
  ...
  def render(assigns) do
    ...
    <div class="flex h-screen bg-gray-50">
      <!-- Sidebar -->
      <.live_component module={TrialAppWeb.SidebarComponent} id="sidebar" current_scope={@current_scope} socket={@socket} />
                  ...
                  <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between mb-6">
                      <h2 class="text-2xl font-bold text-gray-900 flex items-center gap-3">
                        ...
                        Teams in <%= @selected_department.name %>
                      </h2>
                      <%= if @current_scope.user.role == "admin" do %>
                        <button
                    ...
                    <% else %>
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <%= for team <- @selected_department.teams do %>
                          <div class="bg-blue-50 rounded-lg p-4 border border-blue-200 hover:shadow-md transition-all cursor-pointer group relative"
                               phx-click="show_team_detail" phx-value-id={team.id}>
                  ...
                  <%= if @show_team_detail do %>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                      <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-gray-900 flex items-center gap-3">
                          <span class="text-3xl">👤</span>
                          Team Members in <%= @selected_team.name %>
                        </h2>
                      ...
                      <p class="text-gray-600 mb-6">
                        Department: <span class="font-semibold"><%= @selected_team.department.name %></span>
                    ...
                    <%= if @show_departments do %>
                      ...
                      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                          ...
                          Departments in <%= @selected_org.name %>
                        </h2>
                        <%= if Enum.empty?(@selected_org_departments) do %>
                          ...
                          <div class="text-center py-12 border-2 border-dashed border-gray-300 rounded-xl">
                            ...
                            <p class="text-gray-500 mb-6">Create your first department in this organization.</p>
                            <%= if @current_scope.user.role == "admin" do %>
                              <button
                                phx-click="new_department"
                        ...
                        <% else %>
                          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <%= for dept <- @selected_org_departments do %>
                              <div class="bg-purple-50 rounded-lg p-4 border border-purple-200 hover:shadow-md transition-all cursor-pointer group"
                                   phx-click="show_department_detail" phx-value-id={dept.id}>
                                <div class="flex items-start justify-between mb-3">
                    ...
                    <% else %>
                      <%= if @show_teams do %>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                          <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                            <span class="text-3xl">👥</span>
                            Teams in <%= @selected_org.name %>
                          </h2>
                          <%= if Enum.empty?(@selected_org_teams) do %>
                            <div class="text-center py-8">
                              <div class="text-5xl mb-4">👥</div>
                              <p class="text-gray-600 text-lg">No teams found for this organization.</p>
                            </div>
                          <% else %>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                              <%= for team <- @selected_org_teams do %>
                                <div class="bg-blue-50 rounded-lg p-4 border border-blue-200 hover:shadow-md transition-all cursor-pointer group relative"
                                  ...
                                  <div class="absolute top-2 right-2 flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity" phx-click="stop">
                                    <!-- Edit Button -->
                                    <button
                                      phx-click="edit_team"
                                      phx-value-id={team.id}
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl transform transition-all">
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
              ...
              <button phx-click="hide_org_modal" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <form phx-submit="save_organization" phx-change="update_org_form" class="p-6 space-y-6">
              <div>
                ...
                <input
                  ...
                  class={[
                    ...
                    if(@errors[:name], do: "border-red-300 bg-red-50 focus:ring-2 focus:ring-red-500", else: "border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500")
                  ]}
                  required
                />
                <%= if @errors[:name] do %>
              ...
              <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                <button type="button" phx-click="hide_org_modal" class="px-6 py-3 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-xl font-semibold transition-colors">
                  Cancel
                </button>
                <button type="submit" class="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg font-semibold">
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl transform transition-all">
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
              ...
              <button phx-click="hide_dept_modal" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                </svg>
              </button>
            ...
            <form phx-submit="save_department" phx-change="update_dept_form" class="p-6 space-y-6">
              <div>
                ...
                <input
                  ...
                  class={[
                    "w-full px-4 py-3 border-2 rounded-xl outline-none transition-all",
                    if(@errors[:name], do: "border-red-300 bg-red-50 focus:ring-2 focus:ring-red-500", else: "border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-green-500")
                  ]}
                  required
                />
                <%= if @errors[:name] do %>
              ...
              <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                <button type="button" phx-click="hide_dept_modal" class="px-6 py-3 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-xl font-semibold transition-colors">
                  Cancel
                </button>
                <button type="submit" class="px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 transition-all shadow-lg font-semibold">
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl transform transition-all">
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
              ...
              <button phx-click="hide_team_modal" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                </svg>
              </button>
            ...
            <form phx-submit="save_team" phx-change="update_team_form" class="p-6 space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <%= for dept <- @selected_org_departments do %>
                    <option value={dept.id} selected={dept.id == String.to_integer(@team_form_data.department_id)}>
                      <%= dept.name %>
                    </option>
                  <% end %>
                </select>
              ...
              <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                <button type="button" phx-click="hide_team_modal" class="px-6 py-3 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-xl font-semibold transition-colors">
                  Cancel
                </button>
                <button type="submit" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg font-semibold">
